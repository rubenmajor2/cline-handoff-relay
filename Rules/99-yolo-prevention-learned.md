...
This file exists because on 2026-05-07 14:30 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 339 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 733 trips (216%)
...
5. **permission denied (wrote to server path locally?)** — 19 trips (6%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 61 time(s)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 38 time(s)
...
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 19 time(s)
...
- Last update: 2026-05-07 14:30 PDT
- Trips tracked total: 339
