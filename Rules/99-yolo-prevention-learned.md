...
This file exists because on 2026-05-28 16:55 MST a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `421` cumulative in the last 30 days
(`165` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 663 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1481 trips (223%)
2. **timeout** — 177 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 166 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 164 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 88 time(s)
...
- Last update: 2026-05-28 16:55 MST
- Trips tracked total: 663
