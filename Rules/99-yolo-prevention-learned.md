...
This file exists because on 2026-05-27 18:26 MST a scan of the last Cline task history
...
## Top failure modes (all-time, 640 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1430 trips (223%)
...
8. **ssh: connect/timeout** — 17 trips (3%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 159 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 82 time(s)
...
- `ssh: connect/timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 17 time(s)
...
- **ssh: connect/timeout** (17 trips) — see `clinerules_search("ssh")`
...
- Last update: 2026-05-27 18:26 MST
- Trips tracked total: 640
