...
This file exists because on 2026-05-04 01:04 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `277` cumulative in the last 30 days
...
## Top failure modes (all-time, 277 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 589 trips (213%)
...
- Last update: 2026-05-04 01:04 PDT
- Trips tracked total: 277
