...
This file exists because on 2026-06-15 05:02 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `186` cumulative in the last 30 days
(`12` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 186 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 485 trips (261%)
...
- Last update: 2026-06-15 05:02 PDT
- Trips tracked total: 186
