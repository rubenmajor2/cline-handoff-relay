...
This file exists because on 2026-05-23 16:39 PDT a scan of the last Cline task history
...
(`84` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 532 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1181 trips (222%)
...
10. **sql: unknown column (DESCRIBE target table first)** — 8 trips (2%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 123 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 72 time(s)
...
- Last update: 2026-05-23 16:39 PDT
- Trips tracked total: 532
