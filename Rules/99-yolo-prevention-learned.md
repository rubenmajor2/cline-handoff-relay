...
This file exists because on 2026-06-12 23:25 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `182` cumulative in the last 30 days
...
## Top failure modes (all-time, 182 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 473 trips (260%)
2. **timeout** — 30 trips (16%)
...
- `timeout > timeout > timeout` — 3 time(s)
...
- Last update: 2026-06-12 23:25 PDT
- Trips tracked total: 182
