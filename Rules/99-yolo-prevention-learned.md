...
This file exists because on 2026-05-08 18:40 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `366` cumulative in the last 30 days
...
## Top failure modes (all-time, 366 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 801 trips (219%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 75 time(s)
...
- Last update: 2026-05-08 18:40 PDT
- Trips tracked total: 366
