...
This file exists because on 2026-05-28 05:51 MST a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `425` cumulative in the last 30 days
...
## Top failure modes (all-time, 651 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1456 trips (224%)
2. **timeout** — 173 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 162 time(s)
...
- Last update: 2026-05-28 05:51 MST
- Trips tracked total: 651
