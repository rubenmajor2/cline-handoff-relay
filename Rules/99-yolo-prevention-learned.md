...
This file exists because on 2026-06-04 21:05 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `154` cumulative in the last 30 days
...
## Top failure modes (all-time, 154 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 398 trips (258%)
...
- Last update: 2026-06-04 21:05 PDT
- Trips tracked total: 154
