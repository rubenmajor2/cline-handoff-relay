...
This file exists because on 2026-06-06 11:21 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `168` cumulative in the last 30 days
...
## Top failure modes (all-time, 168 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 440 trips (262%)
2. **timeout** — 21 trips (12%)
...
- Last update: 2026-06-06 11:21 PDT
- Trips tracked total: 168
