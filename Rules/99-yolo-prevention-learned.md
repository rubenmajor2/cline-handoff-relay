...
This file exists because on 2026-05-24 11:40 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 554 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1233 trips (223%)
2. **timeout** — 141 trips (25%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 135 time(s)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 77 time(s)
...
- Last update: 2026-05-24 11:40 PDT
- Trips tracked total: 554
