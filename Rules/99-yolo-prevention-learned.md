...
This file exists because on 2026-06-13 17:26 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `183` cumulative in the last 30 days
(`14` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 183 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 476 trips (260%)
...
- Last update: 2026-06-13 17:26 PDT
- Trips tracked total: 183
