...
This file exists because on 2026-05-28 15:54 MST a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `417` cumulative in the last 30 days
(`161` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 659 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1472 trips (223%)
2. **timeout** — 176 trips (27%)
...
6. **file/path does not exist** — 24 trips (4%)
7. **tool: generic execution error** — 21 trips (3%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 165 time(s)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 87 time(s)
...
- `file/path does not exist > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 23 time(s)
- `tool: generic execution error > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 21 time(s)
...
- **file/path does not exist** (24 trips) — see `clinerules_search("file/path does not exist")`
- **tool: generic execution error** (21 trips) — see `clinerules_search("tool")`
...
- Last update: 2026-05-28 15:54 MST
- Trips tracked total: 659
