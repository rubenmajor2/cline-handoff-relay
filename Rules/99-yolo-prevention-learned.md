...
This file exists because on 2026-05-11 11:48 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `406` cumulative in the last 30 days
...
## Top failure modes (all-time, 406 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 900 trips (222%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 94 time(s)
...
- Last update: 2026-05-11 11:48 PDT
- Trips tracked total: 406
