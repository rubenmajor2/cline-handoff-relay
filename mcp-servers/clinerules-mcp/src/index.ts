          ...
          const results = await Promise.all(
            checkable.map(async (c) => {
              for (const ep of MINICHECK_ENDPOINTS) {
                ...
                if (verdict !== null) return { claim: c, entailed: verdict };
              }
