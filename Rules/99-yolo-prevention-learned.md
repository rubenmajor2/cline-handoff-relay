...
This file exists because on 2026-05-27 01:21 PDT a scan of the last Cline task history
showed `4` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `416` cumulative in the last 30 days
(`152` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 636 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1421 trips (223%)
...
- Last update: 2026-05-27 01:21 PDT
- Trips tracked total: 636
- New trips this scan: 4
