...
This file exists because on 2026-05-13 17:35 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 435 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 963 trips (221%)
2. **timeout** — 124 trips (29%)
3. **permission denied (wrote to server path locally?)** — 39 trips (9%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 118 time(s)
...
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 38 time(s)
...
- Last update: 2026-05-13 17:35 PDT
- Trips tracked total: 435
