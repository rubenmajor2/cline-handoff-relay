...
This file exists because on 2026-05-29 12:21 MST a scan of the last Cline task history
showed `5` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `465` cumulative in the last 30 days
(`202` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 715 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1604 trips (224%)
2. **timeout** — 187 trips (26%)
...
6. **ssh: connect/timeout** — 28 trips (4%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 183 time(s)
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 176 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 95 time(s)
...
- `ssh: connect/timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 28 time(s)
...
- **ssh: connect/timeout** (28 trips) — see `clinerules_search("ssh")`
...
- Last update: 2026-05-29 12:21 MST
- Trips tracked total: 715
