...
> **Live violation counters:** call `clinerules_stats` to see current 7d/30d/all-time burst rates and the explicit-ask-ignored vs research-without-subagent breakdown. Counters auto-update via `~/Documents/Cline/rule_violations/scan.py`. Last scan: 2026-05-26 20:19:37 PDT — 7d=580, 30d=3595, all-time=3595. If you are reading this rule, you are part of the count — don't add to it.
