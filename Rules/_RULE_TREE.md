...
- **Architecture & fleet** — R: 40,44,45,51,74-76,84,86-89,121,122,138-142,146,148-155,161,189,190,196,200,204,212,215,217,219-221,223,227-232,236,237,250,324,326 (324=model capability claims must cite the official card; Qwen3.8-27B = 262K native / 1M extensible, never under-rate; 326=GLM ring naming: canonical ids, no version aliases, live probe is the only serving truth)
