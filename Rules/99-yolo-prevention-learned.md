...
This file exists because on 2026-06-10 13:40 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `177` cumulative in the last 30 days
...
## Top failure modes (all-time, 177 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 461 trips (260%)
2. **timeout** — 27 trips (15%)
...
- Last update: 2026-06-10 13:40 PDT
- Trips tracked total: 177
