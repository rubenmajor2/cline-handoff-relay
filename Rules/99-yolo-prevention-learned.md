...
This file exists because on 2026-05-24 02:39 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `340` cumulative in the last 30 days
...
## Top failure modes (all-time, 549 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1222 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 130 time(s)
...
- Last update: 2026-05-24 02:39 PDT
- Trips tracked total: 549
