...
This file exists because on 2026-05-26 21:21 PDT a scan of the last Cline task history
showed `6` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `410` cumulative in the last 30 days
(`162` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 629 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1402 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 153 time(s)
...
- Last update: 2026-05-26 21:21 PDT
- Trips tracked total: 629
- New trips this scan: 6
