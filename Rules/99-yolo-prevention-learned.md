...
This file exists because on 2026-05-24 22:41 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 570 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1270 trips (223%)
2. **timeout** — 144 trips (25%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 138 time(s)
...
- Last update: 2026-05-24 22:41 PDT
- Trips tracked total: 570
