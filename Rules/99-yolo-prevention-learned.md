...
This file exists because on 2026-05-21 11:59 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `498` cumulative in the last 30 days
...
## Top failure modes (all-time, 498 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1104 trips (222%)
2. **timeout** — 136 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 130 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 114 time(s)
...
- Last update: 2026-05-21 11:59 PDT
- Trips tracked total: 498
