...
This file exists because on 2026-05-20 02:52 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `489` cumulative in the last 30 days
...
## Top failure modes (all-time, 489 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1083 trips (221%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 111 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 66 time(s)
...
- Last update: 2026-05-20 02:52 PDT
- Trips tracked total: 489
