...
This file exists because on 2026-05-28 10:52 MST a scan of the last Cline task history
...
(`157` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 654 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1462 trips (224%)
...
- Last update: 2026-05-28 10:52 MST
- Trips tracked total: 654
