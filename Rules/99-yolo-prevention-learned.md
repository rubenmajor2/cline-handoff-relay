...
This file exists because on 2026-06-06 11:54 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `169` cumulative in the last 30 days
...
## Top failure modes (all-time, 169 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 440 trips (260%)
...
- Last update: 2026-06-06 11:54 PDT
- Trips tracked total: 169
