...
This file exists because on 2026-05-19 21:51 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `469` cumulative in the last 30 days
...
## Top failure modes (all-time, 469 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1040 trips (222%)
...
- Last update: 2026-05-19 21:51 PDT
- Trips tracked total: 469
