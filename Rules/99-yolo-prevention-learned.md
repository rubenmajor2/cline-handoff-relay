...
This file exists because on 2026-05-24 15:40 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `347` cumulative in the last 30 days
...
## Top failure modes (all-time, 558 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1242 trips (223%)
...
9. **ssh: connect/timeout** — 14 trips (3%)
...
- Last update: 2026-05-24 15:40 PDT
- Trips tracked total: 558
