...
This file exists because on 2026-05-18 23:10 PDT a scan of the last Cline task history
...
(`51` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 460 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1019 trips (222%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 105 time(s)
...
- Last update: 2026-05-18 23:10 PDT
- Trips tracked total: 460
