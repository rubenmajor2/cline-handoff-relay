...
This file exists because on 2026-05-27 22:51 MST a scan of the last Cline task history
...
(`153` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 647 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1446 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 161 time(s)
...
- Last update: 2026-05-27 22:51 MST
- Trips tracked total: 647
