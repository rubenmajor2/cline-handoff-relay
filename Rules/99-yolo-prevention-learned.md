...
This file exists because on 2026-05-22 21:55 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 522 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1159 trips (222%)
...
7. **tool: generic execution error** — 18 trips (3%)
...
14. **php: syntax error (run php -l before deploy)** — 3 trips (1%)
15. **browser_action: failed** — 3 trips (1%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 121 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 69 time(s)
...
- `tool: generic execution error > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 18 time(s)
...
- Last update: 2026-05-22 21:55 PDT
- Trips tracked total: 522
