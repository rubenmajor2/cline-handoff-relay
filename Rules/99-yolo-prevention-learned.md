...
This file exists because on 2026-05-05 03:20 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `315` cumulative in the last 30 days
...
## Top failure modes (all-time, 315 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 680 trips (216%)
...
- Last update: 2026-05-05 03:20 PDT
- Trips tracked total: 315
