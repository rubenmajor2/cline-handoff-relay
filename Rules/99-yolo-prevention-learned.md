...
This file exists because on 2026-05-29 00:03 MST a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `433` cumulative in the last 30 days
(`176` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 681 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1525 trips (224%)
2. **timeout** — 180 trips (26%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 172 time(s)
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 169 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 92 time(s)
...
- Last update: 2026-05-29 00:03 MST
- Trips tracked total: 681
