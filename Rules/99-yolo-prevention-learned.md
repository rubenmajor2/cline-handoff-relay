...
This file exists because on 2026-05-25 05:42 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `363` cumulative in the last 30 days
...
## Top failure modes (all-time, 576 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1283 trips (223%)
2. **timeout** — 147 trips (26%)
...
- Last update: 2026-05-25 05:42 PDT
- Trips tracked total: 576
