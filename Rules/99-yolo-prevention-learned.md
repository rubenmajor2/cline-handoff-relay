...
This file exists because on 2026-05-28 09:51 MST a scan of the last Cline task history
...
(`156` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 653 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1460 trips (224%)
2. **timeout** — 175 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 164 time(s)
...
- Last update: 2026-05-28 09:51 MST
- Trips tracked total: 653
