...
This file exists because on 2026-05-23 13:38 PDT a scan of the last Cline task history
...
(`82` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 530 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1177 trips (222%)
...
- Last update: 2026-05-23 13:38 PDT
- Trips tracked total: 530
