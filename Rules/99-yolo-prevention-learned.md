...
This file exists because on 2026-05-22 20:06 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `348` cumulative in the last 30 days
...
## Top failure modes (all-time, 518 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1149 trips (222%)
...
7. **tool: generic execution error** — 17 trips (3%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 119 time(s)
...
- `tool: generic execution error > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 17 time(s)
...
- Last update: 2026-05-22 20:06 PDT
- Trips tracked total: 518
