...
This file exists because on 2026-05-28 22:01 MST a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `435` cumulative in the last 30 days
...
## Top failure modes (all-time, 680 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1522 trips (224%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 171 time(s)
...
- Last update: 2026-05-28 22:01 MST
- Trips tracked total: 680
