...
This file exists because on 2026-05-20 12:53 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `490` cumulative in the last 30 days
...
## Top failure modes (all-time, 490 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1085 trips (221%)
2. **timeout** — 133 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 127 time(s)
...
- Last update: 2026-05-20 12:53 PDT
- Trips tracked total: 490
