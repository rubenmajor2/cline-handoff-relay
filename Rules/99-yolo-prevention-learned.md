...
This file exists because on 2026-05-14 09:06 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `440` cumulative in the last 30 days
(`103` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 440 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 973 trips (221%)
2. **timeout** — 127 trips (29%)
...
9. **mysql query failed** — 10 trips (2%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 121 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 99 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 48 time(s)
...
- `mysql query failed > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 9 time(s)
...
- Last update: 2026-05-14 09:06 PDT
- Trips tracked total: 440
