...
This file exists because on 2026-05-12 19:19 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `428` cumulative in the last 30 days
...
## Top failure modes (all-time, 428 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 948 trips (221%)
...
- Last update: 2026-05-12 19:19 PDT
- Trips tracked total: 428
