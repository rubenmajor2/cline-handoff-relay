...
This file exists because on 2026-05-24 01:39 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `339` cumulative in the last 30 days
(`96` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 548 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1219 trips (222%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 129 time(s)
...
- Last update: 2026-05-24 01:39 PDT
- Trips tracked total: 548
