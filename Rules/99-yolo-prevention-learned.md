...
This file exists because on 2026-05-26 00:17 PDT a scan of the last Cline task history
...
(`142` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 606 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1352 trips (223%)
...
- Last update: 2026-05-26 00:17 PDT
- Trips tracked total: 606
