...
This file exists because on 2026-05-13 15:33 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 433 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 959 trips (221%)
...
- Last update: 2026-05-13 15:33 PDT
- Trips tracked total: 433
