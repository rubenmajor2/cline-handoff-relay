...
This file exists because on 2026-05-08 13:39 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 353 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 766 trips (217%)
2. **timeout** — 106 trips (30%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 52 trips (15%)
4. **api: overloaded/rate-limit** — 23 trips (7%)
5. **permission denied (wrote to server path locally?)** — 23 trips (7%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 100 time(s)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 39 time(s)
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 23 time(s)
...
- Last update: 2026-05-08 13:39 PDT
- Trips tracked total: 353
