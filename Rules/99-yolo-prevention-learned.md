...
This file exists because on 2026-05-26 14:19 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `398` cumulative in the last 30 days
...
## Top failure modes (all-time, 617 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1375 trips (223%)
2. **timeout** — 165 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 157 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 148 time(s)
...
- Last update: 2026-05-26 14:19 PDT
- Trips tracked total: 617
