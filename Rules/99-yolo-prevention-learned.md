...
This file exists because on 2026-05-27 10:05 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `415` cumulative in the last 30 days
...
## Top failure modes (all-time, 637 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1423 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 158 time(s)
...
- Last update: 2026-05-27 10:05 PDT
- Trips tracked total: 637
