...
This file exists because on 2026-05-08 14:39 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 356 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 772 trips (217%)
2. **timeout** — 107 trips (30%)
...
5. **api: overloaded/rate-limit** — 23 trips (6%)
...
- Last update: 2026-05-08 14:39 PDT
- Trips tracked total: 356
