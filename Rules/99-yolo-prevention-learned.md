...
This file exists because on 2026-05-19 23:51 PDT a scan of the last Cline task history
showed `4` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `484` cumulative in the last 30 days
...
## Top failure modes (all-time, 484 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1072 trips (221%)
...
- Last update: 2026-05-19 23:51 PDT
- Trips tracked total: 484
