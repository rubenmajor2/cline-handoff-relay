...
This file exists because on 2026-05-23 21:39 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `329` cumulative in the last 30 days
...
## Top failure modes (all-time, 537 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1193 trips (222%)
...
7. **tool: generic execution error** — 19 trips (4%)
...
11. **browser_action: failed** — 5 trips (1%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 125 time(s)
...
- `tool: generic execution error > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 19 time(s)
...
- Last update: 2026-05-23 21:39 PDT
- Trips tracked total: 537
