...
This file exists because on 2026-05-28 06:51 MST a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `426` cumulative in the last 30 days
(`155` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 652 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1458 trips (224%)
2. **timeout** — 174 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 163 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 163 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 85 time(s)
...
- Last update: 2026-05-28 06:51 MST
- Trips tracked total: 652
