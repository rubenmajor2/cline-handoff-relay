...
This file exists because on 2026-05-11 08:13 PDT a scan of the last Cline task history
showed `3` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `401` cumulative in the last 30 days
...
## Top failure modes (all-time, 401 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 889 trips (222%)
...
- Last update: 2026-05-11 08:13 PDT
- Trips tracked total: 401
