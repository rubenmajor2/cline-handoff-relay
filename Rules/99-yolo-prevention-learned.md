...
This file exists because on 2026-05-28 20:00 MST a scan of the last Cline task history
showed `3` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `430` cumulative in the last 30 days
(`175` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 675 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1510 trips (224%)
2. **timeout** — 179 trips (27%)
...
7. **tool: generic execution error** — 22 trips (3%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 169 time(s)
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 168 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 91 time(s)
...
- `tool: generic execution error > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 22 time(s)
...
- **tool: generic execution error** (22 trips) — see `clinerules_search("tool")`
...
- Last update: 2026-05-28 20:00 MST
- Trips tracked total: 675
- New trips this scan: 3
