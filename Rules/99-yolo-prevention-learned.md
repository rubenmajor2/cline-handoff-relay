...
This file exists because on 2026-05-14 08:06 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 439 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 971 trips (221%)
2. **timeout** — 126 trips (29%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 120 time(s)
...
- Last update: 2026-05-14 08:06 PDT
- Trips tracked total: 439
