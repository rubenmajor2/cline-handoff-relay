...
This file exists because on 2026-05-06 16:31 PDT a scan of the last Cline task history
...
1. **no-tool-use: model typed prose instead of calling a tool** — 719 trips (216%)
2. **timeout** — 104 trips (31%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 50 trips (15%)
...
- `fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 49 time(s)
...
- Last update: 2026-05-06 16:31 PDT
