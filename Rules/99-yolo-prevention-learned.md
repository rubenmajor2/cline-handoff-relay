...
This file exists because on 2026-05-21 21:16 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `505` cumulative in the last 30 days
(`65` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 505 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1120 trips (222%)
...
- Last update: 2026-05-21 21:16 PDT
- Trips tracked total: 505
