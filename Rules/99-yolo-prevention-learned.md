...
This file exists because on 2026-06-04 02:02 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `149` cumulative in the last 30 days
...
## Top failure modes (all-time, 149 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 386 trips (259%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 92 time(s)
...
- Last update: 2026-06-04 02:02 PDT
- Trips tracked total: 149
