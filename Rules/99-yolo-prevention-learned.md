...
This file exists because on 2026-05-05 16:08 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `321` cumulative in the last 30 days
...
## Top failure modes (all-time, 321 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 693 trips (216%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 57 time(s)
...
- Last update: 2026-05-05 16:08 PDT
- Trips tracked total: 321
