...
This file exists because on 2026-05-22 09:37 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `507` cumulative in the last 30 days
...
## Top failure modes (all-time, 507 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1124 trips (222%)
...
5. **api: overloaded/rate-limit** — 28 trips (6%)
...
- Last update: 2026-05-22 09:37 PDT
- Trips tracked total: 507
