...
This file exists because on 2026-06-16 18:28 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `191` cumulative in the last 30 days
...
## Top failure modes (all-time, 191 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 500 trips (262%)
...
- Last update: 2026-06-16 18:28 PDT
- Trips tracked total: 191
