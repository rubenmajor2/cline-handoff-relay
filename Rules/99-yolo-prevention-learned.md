...
This file exists because on 2026-05-23 15:38 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `331` cumulative in the last 30 days
...
## Top failure modes (all-time, 531 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1179 trips (222%)
...
- Last update: 2026-05-23 15:38 PDT
- Trips tracked total: 531
