...
This file exists because on 2026-05-28 11:52 MST a scan of the last Cline task history
...
## Top failure modes (all-time, 655 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1464 trips (224%)
...
- Last update: 2026-05-28 11:52 MST
- Trips tracked total: 655
