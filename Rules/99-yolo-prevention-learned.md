...
This file exists because on 2026-05-05 20:15 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 332 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 720 trips (217%)
...
- Last update: 2026-05-05 20:15 PDT
- Trips tracked total: 332
