...
This file exists because on 2026-05-20 23:41 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `495` cumulative in the last 30 days
...
## Top failure modes (all-time, 495 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1097 trips (222%)
...
- Last update: 2026-05-20 23:41 PDT
- Trips tracked total: 495
