...
This file exists because on 2026-05-21 00:42 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `496` cumulative in the last 30 days
...
## Top failure modes (all-time, 496 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1099 trips (222%)
2. **timeout** — 135 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 129 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 113 time(s)
...
- Last update: 2026-05-21 00:42 PDT
- Trips tracked total: 496
