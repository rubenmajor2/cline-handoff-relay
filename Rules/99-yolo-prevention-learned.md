...
This file exists because on 2026-05-24 23:41 PDT a scan of the last Cline task history
...
(`113` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 571 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1272 trips (223%)
2. **timeout** — 145 trips (25%)
...
- Last update: 2026-05-24 23:41 PDT
- Trips tracked total: 571
