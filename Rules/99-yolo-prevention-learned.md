...
This file exists because on 2026-05-24 06:40 PDT a scan of the last Cline task history
...
(`98` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 550 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1225 trips (223%)
2. **timeout** — 139 trips (25%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 133 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 131 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 76 time(s)
...
- Last update: 2026-05-24 06:40 PDT
- Trips tracked total: 550
