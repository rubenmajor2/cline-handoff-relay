...
This file exists because on 2026-05-09 21:07 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 380 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 834 trips (219%)
2. **timeout** — 109 trips (29%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 103 time(s)
...
- Last update: 2026-05-09 21:07 PDT
- Trips tracked total: 380
