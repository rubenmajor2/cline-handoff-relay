...
This file exists because on 2026-05-27 20:29 MST a scan of the last Cline task history
...
## Top failure modes (all-time, 642 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1434 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 83 time(s)
...
- Last update: 2026-05-27 20:29 MST
- Trips tracked total: 642
