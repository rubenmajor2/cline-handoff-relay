...
This file exists because on 2026-05-04 09:18 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `278` cumulative in the last 30 days
...
## Top failure modes (all-time, 278 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 592 trips (213%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 42 time(s)
...
- Last update: 2026-05-04 09:18 PDT
- Trips tracked total: 278
