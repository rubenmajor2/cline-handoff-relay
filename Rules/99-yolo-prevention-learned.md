...
This file exists because on 2026-05-10 21:08 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 391 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 862 trips (220%)
2. **timeout** — 119 trips (30%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 35 trips (9%)
4. **permission denied (wrote to server path locally?)** — 30 trips (8%)
...
- Last update: 2026-05-10 21:08 PDT
- Trips tracked total: 391
