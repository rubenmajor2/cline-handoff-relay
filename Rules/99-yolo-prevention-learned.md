...
This file exists because on 2026-08-17 11:00 PDT a scan of the last Cline task history
...
1. **no-tool-use: model typed prose instead of calling a tool** — 95 occurrences (122% of 78 trips)
2. **timeout** — 43 occurrences (55% of 78 trips)
3. **tool: missing required parameter** — 36 occurrences (46% of 78 trips)
4. **file/path does not exist** — 13 occurrences (17% of 78 trips)
5. **sql: unknown column (DESCRIBE target table first)** — 11 occurrences (14% of 78 trips)
6. **ssh: connect/timeout** — 4 occurrences (5% of 78 trips)
7. **permission denied (wrote to server path locally?)** — 3 occurrences (4% of 78 trips)
8. **mysql query failed** — 3 occurrences (4% of 78 trips)
9. **api: overloaded/rate-limit** — 2 occurrences (3% of 78 trips)
10. **api: credit exhausted (escalate, no retry)** — 1 occurrences (1% of 78 trips)
11. **tool: generic execution error** — 1 occurrences (1% of 78 trips)
...
- Last update: 2026-08-17 11:00 PDT
