...
This file exists because on 2026-05-28 14:54 MST a scan of the last Cline task history
...
(`160` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 658 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1470 trips (223%)
...
- Last update: 2026-05-28 14:54 MST
- Trips tracked total: 658
