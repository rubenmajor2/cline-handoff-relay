...
This file exists because on 2026-05-21 18:22 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `499` cumulative in the last 30 days
(`59` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 499 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1106 trips (222%)
...
12. **shell: command not found** — 3 trips (1%)
...
- Last update: 2026-05-21 18:22 PDT
- Trips tracked total: 499
