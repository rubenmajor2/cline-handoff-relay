...
This file exists because on 2026-05-17 12:33 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `458` cumulative in the last 30 days
...
## Top failure modes (all-time, 458 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1014 trips (221%)
...
10. **sql: unknown column (DESCRIBE target table first)** — 5 trips (1%)
...
- Last update: 2026-05-17 12:33 PDT
- Trips tracked total: 458
