...
This file exists because on 2026-05-21 05:42 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `497` cumulative in the last 30 days
...
## Top failure modes (all-time, 497 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1102 trips (222%)
...
- Last update: 2026-05-21 05:42 PDT
- Trips tracked total: 497
