...
This file exists because on 2026-06-18 14:18 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `194` cumulative in the last 30 days
...
## Top failure modes (all-time, 194 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 503 trips (259%)
2. **timeout** — 33 trips (17%)
...
- Last update: 2026-06-18 14:18 PDT
- Trips tracked total: 194
