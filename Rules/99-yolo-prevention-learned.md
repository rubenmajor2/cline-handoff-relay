...
This file exists because on 2026-05-20 18:45 PDT a scan of the last Cline task history
showed `3` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `493` cumulative in the last 30 days
...
## Top failure modes (all-time, 493 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1093 trips (222%)
2. **timeout** — 134 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 128 time(s)
...
- Last update: 2026-05-20 18:45 PDT
- Trips tracked total: 493
