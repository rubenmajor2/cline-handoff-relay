...
This file exists because on 2026-05-12 17:18 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 424 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 939 trips (221%)
2. **timeout** — 123 trips (29%)
3. **permission denied (wrote to server path locally?)** — 36 trips (8%)
...
7. **tool: generic execution error** — 15 trips (4%)
8. **ssh: connect/timeout** — 12 trips (3%)
9. **mysql query failed** — 9 trips (2%)
10. **sql: unknown column (DESCRIBE target table first)** — 3 trips (1%)
11. **plan: no terminal action (must include safe_deploy/sql_execute/write/send)** — 3 trips (1%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 117 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 97 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 45 time(s)
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 35 time(s)
...
- `mysql query failed > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 8 time(s)
...
- Last update: 2026-05-12 17:18 PDT
- Trips tracked total: 424
