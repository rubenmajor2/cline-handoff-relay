...
This file exists because on 2026-05-27 21:29 MST a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `418` cumulative in the last 30 days
(`150` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 644 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1439 trips (223%)
2. **timeout** — 172 trips (27%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 161 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 160 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 84 time(s)
...
- `api: overloaded/rate-limit > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 29 time(s)
...
- `ssh: connect/timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 18 time(s)
...
- **ssh: connect/timeout** (18 trips) — see `clinerules_search("ssh")`
...
- Last update: 2026-05-27 21:29 MST
- Trips tracked total: 644
- New trips this scan: 2
