...
This file exists because on 2026-05-07 18:36 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 341 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 738 trips (216%)
2. **timeout** — 104 trips (30%)
...
- Last update: 2026-05-07 18:36 PDT
- Trips tracked total: 341
