...
This file exists because on 2026-05-08 11:39 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 350 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 758 trips (217%)
...
5. **permission denied (wrote to server path locally?)** — 22 trips (6%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 64 time(s)
...
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 22 time(s)
...
- Last update: 2026-05-08 11:39 PDT
- Trips tracked total: 350
