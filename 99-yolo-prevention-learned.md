...
This file exists because on 2026-05-03 11:51 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `274` cumulative in the last 30 days
...
## Top failure modes (all-time, 274 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 582 trips (212%)
2. **timeout** — 107 trips (39%)
...
- Last update: 2026-05-03 11:51 PDT
- Trips tracked total: 274
