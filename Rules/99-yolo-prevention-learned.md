...
This file exists because on 2026-05-25 01:42 PDT a scan of the last Cline task history
showed `2` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `360` cumulative in the last 30 days
...
## Top failure modes (all-time, 573 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1276 trips (223%)
2. **timeout** — 146 trips (25%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 139 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 136 time(s)
...
- `file/path does not exist > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 21 time(s)
...
- Last update: 2026-05-25 01:42 PDT
- Trips tracked total: 573
