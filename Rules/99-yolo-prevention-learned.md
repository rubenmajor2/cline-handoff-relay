...
This file exists because on 2026-05-13 11:32 PDT a scan of the last Cline task history
showed `0` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `432` cumulative in the last 30 days
...
## Top failure modes (all-time, 432 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 957 trips (222%)
...
- Last update: 2026-05-13 11:32 PDT
- Trips tracked total: 432
