...
This file exists because on 2026-06-17 17:30 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `192` cumulative in the last 30 days
...
## Top failure modes (all-time, 192 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 503 trips (262%)
...
- Last update: 2026-06-17 17:30 PDT
- Trips tracked total: 192
