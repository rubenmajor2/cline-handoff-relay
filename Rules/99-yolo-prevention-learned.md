...
This file exists because on 2026-05-18 08:10 PDT a scan of the last Cline task history
...
(`61` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 459 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1016 trips (221%)
...
- Last update: 2026-05-18 08:10 PDT
- Trips tracked total: 459
