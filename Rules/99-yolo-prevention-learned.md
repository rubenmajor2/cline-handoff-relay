...
This file exists because on 2026-05-15 18:42 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 448 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 993 trips (222%)
2. **timeout** — 127 trips (28%)
...
9. **mysql query failed** — 11 trips (2%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 50 time(s)
...
- `mysql query failed > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 10 time(s)
...
- Last update: 2026-05-15 18:42 PDT
- Trips tracked total: 448
