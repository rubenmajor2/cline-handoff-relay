...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Live fleet tier health: which tiers are UP/DOWN, latency per tier, any recent flips or anomalies. Queries the fleet API live (bounded 10s fetch). Returns tier status map + staleness note if the API is unreachable. Use with frankenstein_architecture before any routing decision. STDIO, cannot hang.",
    inputSchema: { type: "object", properties: {}, required: [] },
  },
  {
