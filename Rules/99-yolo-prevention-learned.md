...
This file exists because on 2026-05-25 23:17 PDT a scan of the last Cline task history
...
(`141` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 601 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1340 trips (223%)
2. **timeout** — 157 trips (26%)
...
8. **mysql query failed** — 15 trips (2%)
9. **ssh: connect/timeout** — 15 trips (2%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 150 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 144 time(s)
...
- Last update: 2026-05-25 23:17 PDT
- Trips tracked total: 601
