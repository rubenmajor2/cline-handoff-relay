...
This file exists because on 2026-05-28 13:54 MST a scan of the last Cline task history
...
(`159` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 657 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1468 trips (223%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 86 time(s)
...
- Last update: 2026-05-28 13:54 MST
- Trips tracked total: 657
