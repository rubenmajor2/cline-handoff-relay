...
> **Live violation counters:** call `clinerules_stats` to see current 7d/30d/all-time burst rates and the explicit-ask-ignored vs research-without-subagent breakdown. Counters auto-update via `~/Documents/Cline/rule_violations/scan.py`. Last scan: 2026-06-06 21:52:26 PDT — 7d=9, 30d=1985, all-time=3829. If you are reading this rule, you are part of the count — don't add to it.
