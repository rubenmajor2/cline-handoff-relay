...
This file exists because on 2026-05-12 02:49 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 410 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 909 trips (222%)
2. **timeout** — 122 trips (30%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 116 time(s)
...
- Last update: 2026-05-12 02:49 PDT
- Trips tracked total: 410
