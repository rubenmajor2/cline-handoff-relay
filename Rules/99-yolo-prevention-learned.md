...
This file exists because on 2026-05-07 23:51 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 345 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 746 trips (216%)
2. **timeout** — 105 trips (30%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 52 trips (15%)
4. **api: overloaded/rate-limit** — 23 trips (7%)
5. **permission denied (wrote to server path locally?)** — 21 trips (6%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 99 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 62 time(s)
...
- `permission denied (wrote to server path locally?) > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 21 time(s)
...
- Last update: 2026-05-07 23:51 PDT
- Trips tracked total: 345
