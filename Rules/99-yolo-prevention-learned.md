...
This file exists because on 2026-05-24 12:40 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `346` cumulative in the last 30 days
...
## Top failure modes (all-time, 555 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1236 trips (223%)
...
- Last update: 2026-05-24 12:40 PDT
- Trips tracked total: 555
