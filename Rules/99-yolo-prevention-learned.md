...
This file exists because on 2026-05-06 17:31 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `334` cumulative in the last 30 days
...
## Top failure modes (all-time, 334 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 721 trips (216%)
2. **timeout** — 104 trips (31%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 51 trips (15%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 59 time(s)
- `fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 50 time(s)
...
- Last update: 2026-05-06 17:31 PDT
- Trips tracked total: 334
