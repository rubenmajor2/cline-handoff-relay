...
This file exists because on 2026-05-17 00:26 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 452 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1001 trips (221%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 103 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 52 time(s)
...
- `mysql query failed > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 11 time(s)
...
- Last update: 2026-05-17 00:26 PDT
- Trips tracked total: 452
