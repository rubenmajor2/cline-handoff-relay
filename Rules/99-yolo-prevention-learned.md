...
This file exists because on 2026-05-24 18:40 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 567 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1264 trips (223%)
2. **timeout** — 142 trips (25%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 136 time(s)
...
- Last update: 2026-05-24 18:40 PDT
- Trips tracked total: 567
