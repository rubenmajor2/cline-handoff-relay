...
This file exists because on 2026-05-20 01:52 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `485` cumulative in the last 30 days
...
## Top failure modes (all-time, 485 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 1074 trips (221%)
2. **timeout** — 132 trips (27%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 65 time(s)
...
- Last update: 2026-05-20 01:52 PDT
- Trips tracked total: 485
