...
This file exists because on 2026-05-09 08:42 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `373` cumulative in the last 30 days
...
## Top failure modes (all-time, 373 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 818 trips (219%)
2. **timeout** — 107 trips (29%)
...
- `timeout > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 101 time(s)
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 78 time(s)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > (none)` — 42 time(s)
...
- Last update: 2026-05-09 08:42 PDT
- Trips tracked total: 373
