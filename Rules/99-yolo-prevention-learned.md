...
This file exists because on 2026-05-13 21:05 PDT a scan of the last Cline task history
...
(`102` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 438 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 969 trips (221%)
...
- Last update: 2026-05-13 21:05 PDT
- Trips tracked total: 438
