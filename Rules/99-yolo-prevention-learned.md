...
This file exists because on 2026-05-04 15:19 PDT a scan of the last Cline task history
showed `1` new "[YOLO MODE] Task failed: Too many consecutive mistakes (3)"
trips this scan, against `280` cumulative in the last 30 days
...
## Top failure modes (all-time, 280 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 597 trips (213%)
2. **timeout** — 109 trips (39%)
...
- Last update: 2026-05-04 15:19 PDT
- Trips tracked total: 280
