...
This file exists because on 2026-05-15 12:35 PDT a scan of the last Cline task history
...
(`91` in the last 7 days). The cumulative number doesn't grow unless
...
## Top failure modes (all-time, 441 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 976 trips (221%)
...
- `no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool > no-tool-use: model typed prose instead of calling a tool` — 100 time(s)
...
- Last update: 2026-05-15 12:35 PDT
- Trips tracked total: 441
