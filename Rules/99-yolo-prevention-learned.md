...
This file exists because on 2026-05-09 12:42 PDT a scan of the last Cline task history
...
## Top failure modes (all-time, 377 trips)

1. **no-tool-use: model typed prose instead of calling a tool** — 827 trips (219%)
2. **timeout** — 108 trips (29%)
3. **fpm-reload: sudoers blocks systemctl, use kill -USR2 wrapper** — 52 trips (14%)
...
- Last update: 2026-05-09 12:42 PDT
- Trips tracked total: 377
